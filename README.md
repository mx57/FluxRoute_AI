...
**FluxRoute AI** является образовательным и исследовательским программным обеспечением, предназначенным для изучения сетевых технологий, анализа механизмов фильтрации трафика и экспериментов с методами адаптивной маршрутизации.

Данное ПО **не является** инструментом для нарушения действующего законодательства любой юрисдикции. Автор не несёт ответственности за любое использование программы, противоречащее применимому законодательству.

Пользователь несёт персональную ответственность за законность использования данного программного обеспечения в своей стране. Перед использованием ознакомьтесь с местными нормативными актами.

Проект распространяется под лицензией **GPLv3** и предназначен исключительно для lawful research и educational purposes.
