...
- [x] **Интеграция Sing-Box:** Поддержка VLESS, Reality и других современных протоколов.
- [x] **Cloud AI Sync:** Возможность делиться удачными "мутациями" с сообществом анонимно.
